...
if (strtolower($_SESSION['rol']) !== 'docente') {
    die('❌ Solo los docentes pueden editar incidencias.');
}
...
<div class="container">
    <div class="header">
        ...
        <a href="consulta.php" class="btn-back"><i class="fas fa-arrow-left"></i> Volver</a>
    </div>
    <div class="body">
        <?php if ($errors): ?>
